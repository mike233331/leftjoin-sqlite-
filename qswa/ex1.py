...
cur.executescript('''DROP TABLE IF EXISTS orders;
...
cur.executescript('''INSERT INTO products (name, company, items_count, price)
VALUES
...
price = cur.execute('''SELECT name, created_at, items_count, price, product_id
